...
<%
    ...
    {
        int state = Function.IsLogin(Request.Form["Log_username"].Trim(), Request.Form["Log_password"].Trim());
        if (state == 1)
        {
            {
                HttpCookie aCookie;
        ...
        {
            errorMessage = "Onay Verilmemiş Kullanıcı!";
        }
        else if (state == -1)
        {
    ...
    if (Request.QueryString["i"] == "register")
    {
        ...
        {
            errorMessage = "Bu Email Sistemde Zaten Kayıtlı.";
        }
        else if (Sql.Cell("select Count(id) from users where UserName=?1",Request.Form["Reg_username"]) != "0")
        {
        ...
        else
        {
            try
            {
                ...
                errorMessage = "Onay için bekleyiniz.";
            }
            catch (Exception)
            {
            ...
            <div id="register" class="animate form registration_form">
                <section class="login_content">
                    <form action="?i=register#signup" method="post">
                        ...
                        <div>
                            <textarea class="form-control" rows="3" cols="40" name="address" placeholder="Adres">Adres</textarea>
                        </div>
